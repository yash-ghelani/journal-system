    ...
    public void handleRegisterSuccess(ActionEvent action) throws IOException, SQLException {
        ...
        && validFirstName && validLastName && validUniversityName && validEmail && validPassword){
            ...
            if (roleValue == "Author") {
                ...
                ReviewerTable.Insert(prefixValue, firstName.getText(), lastName.getText(), university.getText(), emailField.getText(), Integer.toString(passWordField.getText().hashCode()),temp);
